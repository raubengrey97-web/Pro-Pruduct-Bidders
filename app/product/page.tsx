            ...
            {products.map(p => (
              <div key={p.id} style={{ background: '#fff', border: '1px solid #ececec', borderRadius: '12px', overflow: 'hidden' }}>
                {p.photo_url ? (
                  ...
                  <div style={{ width: '100%', height: '140px', background: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ccc', fontSize: '13px' }}>No image</div>
                )}
                <div style={{ padding: '16px' }}>
                  ...
                  <p style={{ fontSize: '11px', color: '#888', marginBottom: '8px' }}>⏱ {p.days_in_system} days · 💰 10% commission on resale</p>
                  ...
                  {showPayment[p.id] && (
                    <div style={{ marginTop: '8px', background: '#fffbeb', border: '1px solid #f6d860', borderRadius: '10px', padding: '14px' }}>
                      ...
                      <p style={{ fontSize: '12px', color: '#666', marginBottom: '4px', fontWeight: 500 }}>
                        📌 Note: 10% commission will be deducted when you resell this product.
                      </p>
                      <p style={{ fontSize: '12px', color: '#888', marginBottom: '8px' }}>
                        After paying, enter your transaction reference code:
                      </p>
                      <input type="text" placeholder="e.g. AIR1234567 or MTN9876543"
                        value={refCodes[p.id] || ''}
